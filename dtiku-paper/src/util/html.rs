...
pub fn contains_media(html: &str) -> bool {
    // 只要出现常见多媒体标签或常见资源后缀，就认为包含媒体
    ...
    // 或者链接中出现常见媒体扩展名
    const MEDIA_EXTS: [&str; 8] = [
        ".jpg", ".jpeg", ".png", ".gif", ".svg", ".mp4", ".mp3", ".webm",
    ];
    MEDIA_EXTS.iter().any(|ext| lower.contains(ext))
}
...
mod tests {
    ...
    fn test_find_media() {
        let html = r#"
            <div><img src="cat.png"><audio src="music.mp3"></audio></div>
        "#;
