...
impl OrderLevel {
    ...
    pub fn discount_rate(&self) -> f32 {
        match self {
            Self::Monthly => 1.0,
            Self::Quarterly => 0.8334,
            Self::HalfYear => 0.6667,
            Self::Annual => 0.5000,
        }
    }
    ...
    /// 单位为分
    /// 30天5块钱 = 不打折
    /// 90天15块钱 = 1500 * 0.8334 = 1250分
    /// 180天30块钱 = 3000 * 0.6667 = 2000分
    /// 360天60块钱 = 6000 * 0.5000 = 3000分
    #[inline]
    ...
    /// 单位为分(抹了零头)
    /// 30天5块钱 = 不打折
    /// 90天15块钱 = 1500 * 0.8334 = 1250分 = 12.5块
    /// 180天30块钱 = 3000 * 0.6667 = 2000分 = 20块
    /// 360天60块钱 = 6000 * 0.5000 = 3000分 = 30块
    #[inline]
